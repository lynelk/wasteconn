...
export default function DispatchJobList({ jobs, selectedJobs, onToggle, loading, zones }) {
  if (loading) return (
        ...
        return (
          <div
            ...
            className={cn(
              ...
              selected ? "border-primary bg-primary/5" : "border-border/60 hover:border-primary/40 bg-card"
            )}
          >
            <div className={cn(
